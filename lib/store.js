...
(function (global) {
  ...
  const DEFAULT_CONFIG = {
    ...
    token: "",
    weeks: 3,
    // Analysis start date = first week displayed (ISO "YYYY-MM-DD").
    // The window covers that week plus the 4 following ones, stopping at the
    // current week when it falls inside that period.
    // Empty => window of 5 weeks ending on the current week.
    startDate: "",
